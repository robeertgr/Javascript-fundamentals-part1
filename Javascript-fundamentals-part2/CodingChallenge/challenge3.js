/*
    ...
    calculations! Remember: BMI = mass / height ** 2. (Mass
    ...
    TEST DATA: Marks weights 78 kg anmd is 1.69 m tall.
...
console.log(mark.bmi > john.bmi ? `${mark.fullname} BMI (${mark.bmi}) is higher than ${john.fullname} ${john.bmi}!` : `${john.fullname} BMI (${john.bmi}) is higher than ${mark.fullname} ${mark.bmi}!`);
