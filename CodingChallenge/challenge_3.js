/*
    ...
    test for that a well (draw means they have the same
    average score).
    ...
    TEST DATA BONUS 1: Dolphins score 97, 112 ans 101.
...
if (dolphinsScore === koalasScore){
    ...
    if (dolphinsScore >= minimumScore || koalasScore >= minimumScore){
        if (dolphinsScore > koalasScore) {
            console.log(`Dolphins is the winner with ${dolphinsScore} points`);
        } else {
            console.log(`Koalas is the winner with ${koalasScore} points`);
        }    
    } else {
        console.log(`None of the teams reached the minimum score of ${minimumScore}`);
    }
}
